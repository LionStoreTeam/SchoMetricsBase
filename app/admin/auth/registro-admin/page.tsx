                ...
                <CardHeader>
                    <div className="w-full flex flex-col justify-between items-center bg-white mb-5 md:flex-row">
                        <Link href="/" className="flex items-center justify-center gap-3">
                            ...
                            <span className="text-2xl font-bold text-[#00b38c] pl-2">SchoMetrics</span>
                        </Link>
                        <Link href="/admin">
                            <Button>
                                Volver a Inicio
                    ...
                    <CardTitle className="text-2xl text-slate-600">Registro de Administrador</CardTitle>
                    <CardDescription className="text-sm text-muted-foreground">Crea una cuenta de administrador para gestionar la plataforma SchoMetrics</CardDescription>
                </CardHeader>
                <CardContent>
