...
import { CalendarIcon, Check, Loader2, Gift, ArrowLeft, ArrowLeftCircleIcon } from 'lucide-react'; // Añadir Building y PlusCircle
...
export default function CrearRecompensa() {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        ...
        setFormData((prev) => ({
            ...prev,
            [name]: name === "pointsCost" || name === "quantity" ? Number.parseInt(value) || 10 : value,
        }));
    };
    ...
    const handleSubmitReward = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setFormData({
                ...
                available: true, hasQuantity: true, quantity: 10, hasExpiration: false, expiresAt: null,
            });
        } catch (error) {
                    ...
                    <form onSubmit={handleSubmitReward}>
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center space-x-2 pt-2">
                                <Switch id="available-reward" checked={formData.available} onCheckedChange={(checked) => handleSwitchChange("available", checked)} disabled />
