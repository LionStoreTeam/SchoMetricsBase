...
import {
    User, MapPin, Phone, Edit, Camera, Save, X, Trash2, // Renamed Calendar to CalendarIconLucide
...
export default function ProfilePage() {
    ...
    useEffect(() => {
        const fetchUserStats = async () => {
            ...
            try {
                const statsResponse = await fetch(`/api/admin/users/profiles/stats/${userId}`);
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await fetch(`/api/admin/users/profiles/${userId}`, { method: "PUT", body: payload });
            if (!response.ok) {
                    ...
                    <div className="flex flex-col justify-center items-center gap-2 lg:flex-row  lg:justify-between">
                        <div className="my-3">
                            <div className="flex items-center gap-3">
                                ...
                                <h1 className="text-3xl font-bold tracking-wide">Edita o Elimina Usuarios</h1>
                            </div>
                            <p className="text-purple-100 tracking-wide">
                                Edita la información o Elimina Usuarios que ya no tendrán participación en SchoMetrics.
                            </p>
                        </div>
                        <GoToBackAdmin />
                    </div>
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8 mt-10">
                    <div className="flex flex-col items-center justify-center mb-4 md:flex-row">
                        <Settings className="h-12 w-12 text-rose-700 mr-3" />
                        <h1 className="text-3xl font-bold text-gray-900">SchoMetrics</h1>
                    </div>
                    <div className="px-2 flex flex-col items-center justify-center">
                        <ul className="flex flex-col gap-5">
                            <li className="">
                                <a href="#delete_user" className="flex flex-col justify-center items-center text-center gap-2 md:flex-row">
                                    <Trash2 className="h-5 w-5 text-rose-700 mr-3" />
                                    Elimina Usuarios que ya no tendrán participación en SchoMetrics
                                </a>
                            </li>
                            <li className="">
                                <a href="#edit_info" className="flex flex-col justify-center items-center text-center gap-2 md:flex-row">
                                    <Edit className="h-5 w-5 text-blue-700 mr-3" />
                ...
                {/* Status Badge */}
                <div className="m-2 flex justify-center mb-6">
                    <div className="border-b-2 border-b-red-700 text-rose-800 px-4 py-2 text-sm flex gap-1 justify-center items-center font-semibold">
                ...
                <Card className="shadow-lg m-2">
                    <CardHeader className="bg-gradient-to-r from-teal-950 to-sky-950 text-white">
                        <div className="flex flex-col items-center justify-between p-4 md:flex-row">
                            <div className="flex flex-col text-sky-50 gap-2">
                                <CardTitle className="flex items-center text-center text-xl">
                                    <User className="h-6 w-6 mr-2" />
                                    Información del Usuario
                                </CardTitle>
                                <CardDescription className="text-rose-50 text-center tracking-wider">
                            ...
                            <div className="mt-5 p-1 rounded-full bg-white">
                                <Avatar className="w-[80px] h-[80px]">
                                    ...
                                    <AvatarFallback className="bg-rose-100 text-rose-600 font-semibold text-[25px]" >
                    ...
                    <CardContent className="p-3 md:p-6">
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                <h3 className="text-lg font-semibold text-rose-900 border-b pb-2">Datos Personales Básicos</h3>
                            ...
                            <div className="space-y-4">
                                <h3 className="text-lg font-semibold text-rose-900 border-b pb-2">Información y Progreso Actual</h3>
                                <div className="space-y-3">
                                    <div>
                                        <label className="text-sm font-medium text-gray-500">EcoPoints Totales</label>
                                    ...
                                    <div className="flex flex-col items-start gap-2 text-sm">
                                        <span className="text-sm font-medium text-gray-500">Actividades Totales:</span>
                        ...
                        <div className="w-full flex flex-col justify-center items-center">
                            <h2 className="text-lg font-semibold text-rose-900">Acciones Disponibles</h2>
                            <div className="mt-5 p-2 flex flex-col justify-center items-center gap-5 md:flex-row md:justify-around md:items-center ">
                                {/* Notificaciones */}
                                <div className="w-full flex justify-center items-center">
                                    <div className="w-[300px] flex flex-col items-center justify-center p-4 border-2 border-green-500 rounded-md border-dashed transition-all ease-in-out duration-300 hover:border-dotted">
                                        <h2 className="text-green-500 font-semibold">Envía Notificaciones</h2>
                                        <p className="text-center my-4 text-gray-500">Aquí podrás enviar notificaciones al usuario ante cualquier modificación, error o situación con respecto a su perfil.</p>
                                        <AdminSendNotifications />
                                    </div>
                                </div>
                                {/* Eliminar Usuario */}
                                <div className="w-full flex justify-center items-center">
                                    <div id="delete_user" className="w-[300px] flex flex-col items-center justify-center p-4 border-2 border-red-600 rounded-md border-dashed transition-all ease-in-out duration-300 hover:border-dotted">
                                        <h2 className="text-red-600 font-semibold">Zona de Peligro</h2>
                                        <p className="text-center my-4 text-gray-500">Aquí podrás eliminar la cuenta de esté Usuario, está acción es irreversible, se eliminará toda la información asociada al Usuario.</p>
                    ...
                    <CardContent>
                        <Separator className="my-6" />
                        {/* Editar Información */}
                        <h3 id="edit_info" className="text-lg font-semibold text-blue-900 border-b pb-2 w-max">Información General del Usuario</h3>

                        <Card className="md:col-span border-none shadow-none"> {/* Ajustado para que las pestañas ocupen 2 columnas en md y más grandes */}
                            <Tabs value={activeTab} onValueChange={setActiveTab}>
                                <CardHeader>
                                    <div className="flex flex-col justify-between items-center gap-2 pb-2"> {/* Reducido mb */}
                                        {/* <CardTitle>Detalles de la Cuenta</CardTitle> */}
                                        {activeTab === "info" && !isEditing && (
                                            <div className="w-[250px] flex flex-col items-center justify-center p-4 border-2 border-sky-500 rounded-md border-dashed transition-all ease-in-out duration-300 hover:border-dotted">
                                                <Button size="sm" onClick={() => setIsEditing(true)} disabled={isSubmitting} className="bg-sky-500 hover:bg-sky-600">
                                        ...
                                        {activeTab === "info" && isEditing && (
                                            <div className="flex gap-2">
                                                ...
                                                <Button size="sm" className="bg-sky-600 hover:bg-sky-700" onClick={handleSave} disabled={isSubmitting}>
                                        ...
                                        <div className="flex flex-col items-center">
                                            <div className="relative">
                                                <Avatar className="h-24 w-24">
                                                    <AvatarImage src={avatarPreviewUrl || user.profile?.publicAvatarDisplayUrl || ""} alt={user.name || "Avatar"} />
                                                    <AvatarFallback className="text-2xl font-semibold bg-rose-100 text-rose-600 uppercase">{getInitials(user.name)}</AvatarFallback>
                                                </Avatar>
                                            ...
                                            {isEditing && user.profile?.publicAvatarDisplayUrl && !avatarPreviewUrl && (
                                        ...
                                        {isEditing ? (
                                            <>
                                                <div className="grid gap-2">
                                                    ...
                                                    <Input id="name" name="name" value={formData.name} onChange={handleChange} disabled={isSubmitting} className="uppercase" />
                                                </div>
                                                <div className="grid gap-2">
                                                    <Label htmlFor="matricula" className="text-sm font-medium">Matricula (Única e Irrepetible)</Label>
                                                    <Input id="matricula" name="matricula" value={formData.matricula} onChange={handleChange} disabled={isSubmitting} className="uppercase" />
                                                </div>
                                                <div className="grid gap-2">
                                                    <Label htmlFor="points" className="text-sm font-medium">EcoPoints</Label>
                                                    <Input id="points" name="points" type="number" min="0" step="1" value={formData.points} onChange={handleChange} disabled={isSubmitting} className="uppercase" />
                                                </div>
                                                <div className="grid gap-2">
                                            ...
                                            <>
                                                <div className="space-y-1">
                                                    ...
                                                    <p className="uppercase text-muted-foreground">{user.name}</p>
                                                </div>
                                                <div className="space-y-1">
                                                    <h3 className="font-medium flex items-center gap-2 text-sky-500">
                                                        Matricula
                                                    </h3>
                                                    <p className="uppercase text-muted-foreground">{user.matricula}</p>
                                                </div>
                                                <div className="space-y-1">
                                                    <h3 className="font-medium flex items-center gap-2 text-sky-500">
                                                        EcoPoints
                                                    </h3>
                                                    <p className="uppercase text-muted-foreground">{user.points}</p>
                                                </div>
                                                {user.profile?.email && (
                                                    <div className="space-y-1">
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg mt-5">
                            <div className="mt-3 pt-3 border-t border-gray-200">
                                <p className="text-xs text-gray-500 text-center">
                                    Recuerda verificar los datos modificados antés de enviar el formulario.
                                    <br />
                                    La acción de Eliminar Usuario es irreversible, recuerda usarla con precaución.
                                </p>
                            </div>
                        </div>
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm text-gray-500">© {new Date().getFullYear()} SchoMetrics.</p>
                </div>
            </div >
        </>
    );
