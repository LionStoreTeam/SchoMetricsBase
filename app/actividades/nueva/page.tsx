...
import { Recycle, TreePine, Droplets, Lightbulb, Leaf, BookOpen, HelpCircle, Upload, ArrowLeft, BadgeInfo } from "lucide-react"
        ...
        <DashboardLayout>
            <div className="flex flex-col gap-8 m-5">
                <div className="mt-16 lg:mt-0 p-8 flex flex-col gap-3 text-white bg-gradient-to-br from-green-500 via-emerald-600 to-green-600 rounded-xl shadow-2xl">
                    ...
                    <p className="text-lg opacity-90 text-center md:text-start">Registra una nueva actividad ecológica para obtener EcoPoints. Será revisada por un administrador</p>
                </div>
                <div className="mt-3">
                ...
                <div className="w-auto flex justify-center items-center">
                    <Link href="/actividades/manual-de-actividades-permitidas" title="Revisa el Manual de Actividades Permitidas">
                        <Button variant={"outline"} className="text-rose-50 bg-rose-500 font-bold w-auto transition-all ease-linear duration-300 hover:bg-red-600 hover:text-white">
                    ...
                    <form onSubmit={handleSubmit} ref={formRef}>
                        <CardHeader>
                            ...
                            <CardDescription>
                                ...
                                <p>Cantidad mínima de caracteres para la Descripción: 50 - máxima: 500.</p>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid gap-2">
                                    ...
                                    <Input id="quantity" name="quantity" type="number" min="1" max="500" step="1" placeholder="Ejemplo: 10" value={formData.quantity} onChange={handleChange} disabled={isLoading} className={errors.quantity ? "border-red-500" : ""} />
                                    {errors.quantity && <p className="text-sm text-red-500">{errors.quantity}</p>}
                                </div>
                                <div className="grid gap-2">
                                    <Label htmlFor="unit">Unidad</Label>
                                    <Input id="unit" name="unit" placeholder="Ej. kg, litros, árboles" value={formData.unit} onChange={handleChange} disabled className={errors.unit ? "border-red-500" : ""} />
