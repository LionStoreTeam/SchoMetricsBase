...
export default function LoginForm() {
    ...
    return (
        <Card className="w-full max-w-md shadow-lg shadow-blue-200">
            <CardHeader className="space-y-1">
                <div className="w-full  justify-center items-center bg-white mb-5">
                    <Link href="/" className="flex items-center justify-center gap-3">
                        <Image src="/logo.png" alt="logo" width={70} height={70} priority />
                        <span className="text-2xl font-bold pl-2 text-[#00B38C]">SchoMetrics</span>
                    </Link>
                </div>
                <CardTitle className="text-2xl text-slate-600">Iniciar sesión</CardTitle>
                <CardDescription className="text-sm text-muted-foreground">Ingresa tus credenciales para acceder a la plataforma</CardDescription>
            </CardHeader>
            <form onSubmit={handleSubmit}>
                <CardContent className="grid gap-4">
                    ...
                    <div className="flex items-center justify-end">
                        <Link href="/login/recuperar-password" className="text-sm text-[#00B38C] hover:underline">
