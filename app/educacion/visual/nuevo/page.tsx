            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <Card className="max-w-3xl mx-auto 0">
                    <CardHeader>
                        ...
                        <CardDescription>Comparte infografías, carteles educativos o galerías de imágenes.</CardDescription>
                    </CardHeader>
                            ...
                            <div className="pt-4 border-t">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <Input id="authorName" name="authorName" value={formData.authorName} onChange={handleInputChange} disabled={isSubmitting || !!session?.name} className={errors.authorName ? "border-red-500" : "uppercase"} />
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <Input id="authorInstitution" name="authorInstitution" value={formData.authorInstitution} onChange={handleInputChange} disabled={isSubmitting || !!(session?.userType === UserType.TEACHER || session?.userType === UserType.ADMIN && session?.name)} className={errors.authorInstitution ? "border-red-500" : ""} />
