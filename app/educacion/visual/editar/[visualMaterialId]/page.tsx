...
import { BookOpen, Loader2, ImagePlus, Save, X, Trash2, RotateCcw, ArrowLeft } from "lucide-react";
...
export default function EditVisualMaterialPage() {
    ...
    if (!session || (session.id !== originalMaterialUserId) || (session.userType !== UserType.TEACHER && session.userType !== UserType.ADMIN)) {
    ...
    return (
        <DashboardLayout>
            ...
            <div className="container mx-auto px-4 py-8 mt-10 md:mt-2">
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="pt-4 border-t">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        <Label htmlFor="authorName-edit">Nombre del Autor (Usuario actual)<span className="text-red-500">*</span></Label>
                                        <Input id="authorName-edit" name="authorName" value={formData.authorName || ""} onChange={handleInputChange} disabled className={errors.authorName ? "border-red-500" : "uppercase"} />
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <Input id="authorInstitution-edit" name="authorInstitution" value={formData.authorInstitution || ""} onChange={handleInputChange} disabled className={errors.authorInstitution ? "border-red-500" : ""} />
