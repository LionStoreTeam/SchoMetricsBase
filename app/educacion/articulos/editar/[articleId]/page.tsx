...
export default function EditEducationalArticlePage() {
    ...
    if (!session || (session.id !== originalArticleUserId) || (session.userType !== UserType.TEACHER && session.userType !== UserType.ADMIN)) {
        return (
            <DashboardLayout>
                            ...
                            <div className="pt-4 border-t">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <Input id="authorName" name="authorName" value={formData.authorName || ""} onChange={handleInputChange} disabled className={errors.authorName ? "border-red-500" : "uppercase"} />
