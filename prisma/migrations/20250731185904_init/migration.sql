...
-- CreateEnum
CREATE TYPE "public"."RedemptionStatus" AS ENUM ('PENDING', 'COMPLETED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "public"."AnnouncementTopic" AS ENUM ('AVISO_SCHOMETRICS', 'AVISO_ESCOLAR', 'AVISO_AMBIENTAL', 'AVISO_GENERAL');
...
CREATE TABLE "public"."EducationalArticle" (
    ...
    "authorInstitution" TEXT NOT NULL DEFAULT 'Escuela Secundaria Ambiental',
    "authorInfo" TEXT,
    "coverImageUrl" TEXT,
    "userId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
